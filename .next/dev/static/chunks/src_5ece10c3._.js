...
const LEAFLET_JS_CDN = `https://unpkg.com/leaflet@${LEAFLET_VERSION}/dist/leaflet.js`;
const LEAFLET_CSS_CDN = `https://unpkg.com/leaflet@${LEAFLET_VERSION}/dist/leaflet.css`;
...
const ensureLeafletStylesheet = ()=>{
    ...
    link.rel = "stylesheet";
    link.href = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAFLET_CSS_CDN"];
...
const loadLeaflet = async ()=>{
    ...
    if (!leafletLoader) {
        ...
        leafletLoader = new Promise((resolve, reject)=>{
            ...
            script.src = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAFLET_JS_CDN"];
            script.async = true;
            script.integrity = "sha512-y7m90PgsSjD/F7kh/3Gzdhvj1io8GZFODdgNpTi27C/medfyqCkCmDYJLdnOjFkWDXe4sdRQ4pQMBYbgl2hF0A==";
            script.crossOrigin = "";
...
const MapView = ({ tunnelSegments, routePoints, nodes, onMapReady })=>{
    _s();
            ...
            loadLeaflet().then({
                "MapView.useEffect": (L)=>{
                    ...
                    mapInstance = L.map(target, {
                        center: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CENTER"],
                    ...
                    L.tileLayer(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TILE_LAYER_URL"], {
                    ...
                    tunnelSegments.forEach({
                        "MapView.useEffect": (segment)=>{
                            const layer = L.polyline(segment, {
                                color: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$tunnels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TUNNEL_STROKE"],
                                weight: 4,
                                opacity: 0.92,
                                lineCap: "round",
                                lineJoin: "round"
                    ...
                    if (routePoints.length > 1) {
                        const highlightLayer = L.polyline(routePoints, {
                            color: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$tunnels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TUNNEL_HIGHLIGHT"],
                            weight: 6,
                            opacity: 0.88,
                            lineCap: "round",
                            lineJoin: "round"
                    ...
                    nodes.forEach({
                        "MapView.useEffect": (node)=>{
                            const marker = L.circleMarker(node.position, {
                                color: "#ffffff",
                                weight: 2,
                                fillColor: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$tunnels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NODE_COLORS"][node.type],
                                fillOpacity: 0.95,
                                radius: 9
                            }).addTo(mapInstance);
                            marker.bindTooltip(`<div class="tooltip-title">${node.name}</div><div class="tooltip-meta">${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$tunnels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NODE_TYPE_LABEL"][node.type]}</div>`, {
                                direction: "top",
                                offset: [
                                    0,
                                    -12
...
_s(MapView, "f3Vq5/Pj23t4w3n75S7jzOf7K60=");
_c = MapView;
var _c;
...
function HomePage() {
    ...
    const tunnelSegments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[tunnelSegments]": ()=>segments.map({
                "HomePage.useMemo[tunnelSegments]": ([from, to])=>{
            ...
            }["HomePage.useMemo[tunnelSegments]"]).filter({
                "HomePage.useMemo[tunnelSegments]": (segment)=>Boolean(segment)
            }["HomePage.useMemo[tunnelSegments]"])
    }["HomePage.useMemo[tunnelSegments]"], [
        segments,
        nodeLookup
    ]);
    const routePoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[routePoints]": ()=>highlightRoute.map({
    ...
    const handleMapReady = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HomePage.useCallback[handleMapReady]": (instance)=>{
            setMapInstance(instance);
        }
    }["HomePage.useCallback[handleMapReady]"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "app-shell",
        children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    onClick: ()=>mapInstance?.flyTo(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CENTER"], __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$map$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_ZOOM"], {
                                            duration: 0.8
                                        }),
                                    disabled: !mapInstance,
                                    children: "◎"
...
_s(HomePage, "NxN+or+H14G1E16/NnMoW/bCy3g=");
_c = HomePage;
var _c;
